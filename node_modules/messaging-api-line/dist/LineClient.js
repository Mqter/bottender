...
class LineClient {
    constructor(accessTokenOrConfig, channelSecret) {
        ...
        this._dataAxios = axios_1.default.create({
        ...
        this._dataAxios.interceptors.request.use(messaging_api_common_1.createRequestInterceptor({ onRequest: this._onRequest }));
    }
    ...
    _optionWithoutKeys(option, removeKeys) {
        let keys = Object.keys(option);
        keys = difference_1.default(keys, removeKeys);
        keys = difference_1.default(keys, removeKeys.map(key => messaging_api_common_1.snakecase(key)));
        return pick_1.default(option, keys);
    }
    /**
     * Reply Message
     *
     ...
     */
    narrowcastRawBody(body, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post('/v2/bot/message/narrowcast', body, customAccessToken
            ? {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            }
            : {})
            .then(res => {
            return Object.assign({ requestId: res.headers['x-line-request-id'] }, res.data);
        }, handleError);
    }
    narrowcast(messages, options) {
        const filter = (options === null || options === void 0 ? void 0 : options.demographic) ? {
            demographic: options.demographic,
        }
            : undefined;
        const limit = (options === null || options === void 0 ? void 0 : options.max) ? {
    ...
    narrowcastMessages(messages, options) {
        return this.narrowcast(messages, options);
    }
    getNarrowcastProgress(requestId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/message/progress/narrowcast?requestId=${requestId}`, Object.assign({}, (customAccessToken
            ? { headers: { Authorization: `Bearer ${customAccessToken}` } }
            : undefined)))
            .then(res => res.data, handleError);
    }
    ...
    createUploadAudienceGroup(description, isIfaAudience, audiences, options = {}) {
        const bodyOptions = this._optionWithoutKeys(options, ['accessToken']);
        return this._axios
            .post('/v2/bot/audienceGroup/upload', Object.assign({ description,
            isIfaAudience,
            audiences }, bodyOptions), (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
    }
     ...
     */
    updateUploadAudienceGroup(audienceGroupId, audiences, options = {}) {
        const bodyOptions = this._optionWithoutKeys(options, ['accessToken']);
        return this._axios
            .put('/v2/bot/audienceGroup/upload', Object.assign({ audienceGroupId,
            audiences }, bodyOptions), (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
     ...
     */
    createClickAudienceGroup(description, requestId, options = {}) {
        const bodyOptions = this._optionWithoutKeys(options, ['accessToken']);
        return this._axios
            .post('/v2/bot/audienceGroup/click', Object.assign({ description,
            requestId }, bodyOptions), (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
     ...
     */
    createImpAudienceGroup(description, requestId, options = {}) {
        return this._axios
            .post('/v2/bot/audienceGroup/imp', {
            description,
            requestId,
        }, (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
     ...
     */
    setDescriptionAudienceGroup(description, audienceGroupId, options = {}) {
        return this._axios
     ...
     */
    deleteAudienceGroup(audienceGroupId, options = {}) {
        return this._axios
            .delete(`/v2/bot/audienceGroup/${audienceGroupId}`, (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
     ...
     */
    getAudienceGroup(audienceGroupId, options = {}) {
        return this._axios
            .get(`/v2/bot/audienceGroup/${audienceGroupId}`, (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
     ...
     */
    getAudienceGroups(options = {}) {
        const bodyOptions = this._optionWithoutKeys(options, ['accessToken']);
        bodyOptions.page = bodyOptions.page || 1;
        const query = querystring_1.default.stringify(bodyOptions);
        return this._axios
            .get(`/v2/bot/audienceGroup/list?${query}`, (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
     ...
     */
    getAudienceGroupAuthorityLevel(options = {}) {
        return this._axios
            .get(`/v2/bot/audienceGroup/authorityLevel`, (options === null || options === void 0 ? void 0 : options.accessToken) ? {
            headers: { Authorization: `Bearer ${options === null || options === void 0 ? void 0 : options.accessToken}` },
        }
            : {})
            .then(res => res.data, handleError);
     ...
     */
    changeAudienceGroupAuthorityLevel(authorityLevel, options = {}) {
        return this._axios
