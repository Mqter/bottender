...
export declare type Action = PostbackAction | MessageAction | URIAction | DatetimePickerAction;
 ...
 */
export declare type FlexComponent = FlexBox<FlexBoxLayout> | FlexButton | FlexImage | FlexIcon | FlexText | FlexSpan | FlexSeparator | FlexFiller | FlexSpacer;
export declare type FlexBoxLayout = 'horizontal' | 'vertical' | 'baseline';
/**
 * This is a component that defines the layout of child components.
 * You can also include a box in a box.
 */
export declare type FlexBox<L extends FlexBoxLayout> = {
    type: 'box';
    /**
     ...
     *   + [spacer (not recommended)](https://developers.line.biz/en/reference/messaging-api/#spacer)
     */
    contents: L extends 'baseline' ? (FlexIcon | FlexText | FlexFiller | FlexSpacer)[] : (FlexBox<FlexBoxLayout> | FlexButton | FlexImage | FlexText | FlexSeparator | FlexFiller | FlexSpacer)[];
    /**
...
export declare type LinePayConfig = {
    channelId: string;
    channelSecret: string;
    sandbox?: boolean;
    origin?: string;
};
export declare type LinePayCurrency = 'USD' | 'JPY' | 'TWD' | 'THB';
export declare type AccessTokenOptions = {
    accessToken?: string;
};
export declare type NarrowcastOptions = AccessTokenOptions & {
    recipient?: RecipientObject;
    demographic?: DemographicFilterObject;
    max?: number;
};
export declare type FilterOperatorObject<T> = {
    type: 'operator';
} & ({
...
export declare type AudienceObject = {
    type: 'audience';
    audienceGroupId: number;
};
export declare type RecipientObject = AudienceObject | FilterOperatorObject<AudienceObject>;
export declare type DemographicAge = 'age_15' | 'age_20' | 'age_25' | 'age_30' | 'age_35' | 'age_40' | 'age_45' | 'age_50';
export declare type DemographicSubscriptionPeriod = 'day_7' | 'day_30' | 'day_90' | 'day_180' | 'day_365';
export declare type DemographicArea = 'jp_01' | 'jp_02' | 'jp_03' | 'jp_04' | 'jp_05' | 'jp_06' | 'jp_07' | 'jp_08' | 'jp_09' | 'jp_10' | 'jp_11' | 'jp_12' | 'jp_13' | 'jp_14' | 'jp_15' | 'jp_16' | 'jp_17' | 'jp_18' | 'jp_19' | 'jp_20' | 'jp_21' | 'jp_22' | 'jp_23' | 'jp_24' | 'jp_25' | 'jp_26' | 'jp_27' | 'jp_28' | 'jp_29' | 'jp_30' | 'jp_31' | 'jp_32' | 'jp_33' | 'jp_34' | 'jp_35' | 'jp_36' | 'jp_37' | 'jp_38' | 'jp_39' | 'jp_40' | 'jp_41' | 'jp_42' | 'jp_43' | 'jp_44' | 'jp_45' | 'jp_46' | 'jp_47' | 'tw_01' | 'tw_02' | 'tw_03' | 'tw_04' | 'tw_05' | 'tw_06' | 'tw_07' | 'tw_08' | 'tw_09' | 'tw_10' | 'tw_11' | 'tw_12' | 'tw_13' | 'tw_14' | 'tw_15' | 'tw_16' | 'tw_17' | 'tw_18' | 'tw_19' | 'tw_20' | 'tw_21' | 'tw_22' | 'th_01' | 'th_02' | 'th_03' | 'th_04' | 'th_05' | 'th_06' | 'th_07' | 'th_08' | 'id_01' | 'id_02' | 'id_03' | 'id_04' | 'id_06' | 'id_07' | 'id_08' | 'id_09' | 'id_10' | 'id_11' | 'id_12' | 'id_05';
export declare type DemographicObject = {
    type: 'gender';
    oneOf: ('male' | 'female')[];
} | ({
    type: 'age';
...
export declare type CreateUploadAudienceGroupOptions = AccessTokenOptions & {
    uploadDescription?: string;
};
export declare type UpdateUploadAudienceGroupOptions = CreateUploadAudienceGroupOptions & {
    description?: string;
};
export declare type CreateClickAudienceGroupOptions = AccessTokenOptions & {
    clickUrl?: string;
};
export declare type Audience = {
    id: string;
};
export declare type BasicAudienceGroup = {
    /** The audience ID. */
    audienceGroupId: number;
    /** The audience's name. */
    description: string;
...
export declare type UploadAudienceGroup = BasicAudienceGroup & {
    type: 'UPLOAD';
};
export declare type ImpAudienceGroup = BasicAudienceGroup & {
    type: 'IMP';
    requestId: string;
};
export declare type ClickAudienceGroup = BasicAudienceGroup & {
    type: 'CLICK';
...
export declare type AudienceGroup = (UploadAudienceGroup | ImpAudienceGroup | ClickAudienceGroup) & {
...
export declare type AudienceGroups = {
...
export declare type AudienceGroupWithJob = AudienceGroup & {
...
export declare type GetAudienceGroupsOptions = AccessTokenOptions & {
    page?: number;
    description?: string;
    status?: string;
    size?: number;
};
export declare type AudienceGroupAuthorityLevel = {
    authorityLevel: 'PUBLIC' | 'PRIVATE';
};
/**
 * LINE Notify Config
 */
export declare type LineNotifyConfig = {
    /**
...
export declare type LineNotifyOptions = {
    /**
